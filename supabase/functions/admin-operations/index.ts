...
async function verifyCaller(
  ...
  // Cliente efímero, con la ANON key + el JWT del caller reenviado tal
  // cual -- exactamente para lo único que se usa: validar ese JWT contra
  // Supabase Auth (`getUser()`). Nunca se usa para leer/escribir ninguna
  // tabla -- eso lo hace siempre `serviceRoleClient`.
