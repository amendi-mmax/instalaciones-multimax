...
- **(Vigente desde la Fase 5, 2026-07-22)** No se crean más archivos `PHASE_X.md` (`PHASE_5.md`, `PHASE_6.md`, etc.). `PHASE_1.md`–`PHASE_4.md` quedan como documentación histórica, sin modificarse salvo correcciones puntuales. La planificación y el estado del proyecto de aquí en adelante se mantienen exclusivamente vía `PROJECT_STATUS.md`, `docs/SPRINTS_INDEX.md` (índice maestro), `CHANGELOG.md` y un reporte técnico por Sprint (`docs/architecture/frontend/SPRINT_<fase>_<n>_..._REPORT.md`) -- ver `PROJECT_STATUS.md` para el detalle completo de esta decisión.
- **"Modo de Visualización del Administrador" (temporal, vigente mientras el MVP no esté aprobado, Sprint 5.1.1, 2026-07-22)**: un usuario real `admin` puede visualizar temporalmente Administración/Coordinador/Instalador sin cambiar de usuario ni de rol autenticado -- sin tocar `profile.rol`, Auth ni Supabase/RLS, únicamente cambia la interfaz renderizada (`AdminVistaSwitch`, exclusivo de `admin`). Se elimina íntegramente cuando el MVP sea aprobado. Ver `PROJECT_STATUS.md` para el detalle completo.
